...
const LoginPage = () => {
  ...
  try {
    ...
    const userResponse = await loginUserController(data.email, data.password);
    store.setRequestLoading(false);

    console.log("User Response:", userResponse); // Adicionando log de depuração

    if (userResponse.status === "success") {
      store.setAuthUser(userResponse.user);
