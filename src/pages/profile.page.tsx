...
import {generateOTP} from "../../controllers/auth.controller"
import { any, string, ZodAny } from "zod";
...
const ProfilePage = () => {
  ...
  const generateQrCode = async (
    ...
    try {
      ...
      const response = await generateOTP(user_id);
          ...
          <div>
            ...
            {store.authUser?.otp_enabled ? (
              ...
              <button
                ...
                onClick={() =>
                  generateQrCode({ user_id: user?.id! })
                }
              >
                Setup 2FA
              </button>
